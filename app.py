...
def predict():
    if request.method == 'POST':
        ...
        if prediction==1:
             return render_template('index.html',Prediction_res="Oops, The Customer will leave the bank :(" )
        else:
             return render_template('index.html',Prediction_res="Bingo, The Customer will not leave the bank :)" )
